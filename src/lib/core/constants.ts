...
/** 風牌 */
export const KAZEHAI: readonly Kazehai[] = [HaiKind.Ton, HaiKind.Nan, HaiKind.Sha, HaiKind.Pei]

/** 三元牌 */
export const SANGENHAI: readonly HaiKindId[] = [HaiKind.Haku, HaiKind.Hatsu, HaiKind.Chun]
